...
function actualizar_usuario($datos_actualizar)
{
    try{
        $conexion=new PDO("mysql:host=".SERVIDOR_BD.";dbname=".NOMBRE_BD,USUARIO_BD,CLAVE_BD,array(PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES 'utf8'"));
    }
    ...
    $respuesta["mensaje"]="El usuario (".end($datos_actualizar).") ha sido actualizado correctamente";
    $sentencia=null;
    $conexion=null;
    return $respuesta;
}

function actualizar_usuario_sin_clave($datos_actualizar)
{
    try{
        $conexion=new PDO("mysql:host=".SERVIDOR_BD.";dbname=".NOMBRE_BD,USUARIO_BD,CLAVE_BD,array(PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES 'utf8'"));
    }
...
function borrar_usuario($id_usuario)
{
    ...
    $respuesta["mensaje"]="El usuario (".$id_usuario.") ha sido borrado correctamente";
    $sentencia=null;
    $conexion=null;
    return $respuesta;
}
