<?php
 ...
 while($tupla=mysqli_fetch_assoc($datos_usuarios))
 {
     ...
     echo "<td><form action='index.php' method='post'><button class='btn_img' type='submit' value='".$tupla["id_usuario"]."' name='btnBorrar'><img src='images/borrar.png' title='Borrar Usuario' alt='Borrar'/></button></form></td>";
     echo "<td><form action='index.php' method='post'><button class='btn_img' type='submit' value='".$tupla["id_usuario"]."' name='btnEditar'><img src='images/editar.png' title='Editar Usuario' alt='Editar'/></button></form></td>";
     echo "</tr>";
 }
