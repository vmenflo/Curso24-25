...
const DIR_API="http://localhost/Proyectos/Curso24-25/PHP/Tema_6_Servicios_WEB/Servicios_Web/Actividad1/servicios_rest/";
    ...
    .done(function(data2){
        ...
        else
        {
            ...
            .done(function(data2){
                ...
                {
                    $("#respuestas").html("<p class='txt_centrado mensaje'>¡¡ Producto actializado con éxito !!</p>");
                    obtener_productos();
                }
            })
            .fail(function(a,b){
