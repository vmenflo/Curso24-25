...
<body>
    <div>
        Bienvenido <strong><?php echo $datos_usuario_log["usuario"];?> eres <?php echo $datos_usuario_log["tipo"];?> </strong> - <form class="enlinea" action="index.php" method="post"><button class="enlace" type="submit" name="btnCerrarSession">Salir</button></form>
    </div>
    <?php
