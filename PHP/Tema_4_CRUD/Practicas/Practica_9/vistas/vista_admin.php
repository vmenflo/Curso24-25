...
<body>
    <h1>Práctica 9</h1>
    <div>
        Bienvenido Admin <strong><?php echo $datos_usuario_log["usuario"];?></strong> - <form class="enlinea" action="index.php" method="post"><button class="enlace" type="submit" name="btnCerrarSession">Salir</button></form>
    </div>
    <?php
        if(isset($_POST["btnDetalles"]))
        ...
        if(isset($_POST["btnBorrarFoto"]) )
            require "vistas/admin/vista_borrar_foto.php";
