...
<form action='index.php' method='post' enctype='multipart/form-data'>
    ...
    <input type="password" placeholder="Clave..." name="clave" id="clave" value="<?php echo $clave;?>">
    <?php
    ...
    <input type="text" name="dni" id="dni" placeholder="DNI: 09075707E" value="<?php echo $dni;?>">
    <?php
